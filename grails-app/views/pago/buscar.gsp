...
<div class="btn-toolbar toolbar">
    <div class="btn-group">
        <g:link controller="pago" action="list" class="btn btn-secondary">
...
<div class="container-fluid">
    <div class="row justify-content-left align-items-left" style="padding: 20px;">
        <div class="col-auto">
            <label for="criterio" style="color: black; margin-right: 10px;">Buscar por estado:</label>
        </div>
        <div class="col-auto">
...
<script type="text/javascript">
    ...
    function createEditRow(id) {
        ...
        var pag = "${pago}"
        var data = id ? {id: id, pag:pag} : {pag:pag};
        console.log('data', data, pag)
        $.ajax({
            type: "POST",
